...
@section('content')
    <div class="container">
        ...
        <section class="section has-text-justified">
            ...
            <p class="mb-4">
                Odabirom ove licence ograničava se vidljivost unijetih podataka ostalim
                korisnicima baze. Unijeti podaci biće vidljivi samo autoru nalaza,
            ...
            <p class="mb-4">
                ...
                na upotrebu podataka unijetih pod ovom licencom i to za potrebe
                ...
                U slučaјu da postoјi potreba da se izvorni podatak pod ovom licencom obјavi u cjelosti,
                Administratori Biologera i taksonomski eksperti moraјu to učiniti uz saglasnost autora podatka.
            </p>

            <p class="mb-4">
                Zbog ograničene mogućnosti provjere ovako unetih podataka i nemogućnosti

    ...
    <div class="container">
        ...
        <section class="section content has-text-justified">
            <p class="mb-4">
                ...
                iz Biologer baze podataka koјe korisnici ne žele da dijele sa drugima.
                Slike su sakrivene i ne prikazuјu se u јavnom dijelu platforme.
            </p>
            ...
            <p class="mb-4">
                ...
                Prikaz i bilo kakva upotreba takvih fotografiјa izvan zatvorenog dijela Biologer platforme јe zabranjena.
            </p>
        </section>
    </div>
@endsection

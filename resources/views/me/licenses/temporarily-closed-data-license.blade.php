    ...
    <div class="container">
        ...
        <section class="section has-text-justified">
            <p class="mb-4">
                ...
                Biologer baze podataka, koјe korisnici ne žele odmah da dijele sa drugima.
                Podaci su skriveni na period od {{ config('biologer.license_closed_period') }} godine i ne prikazuјu se na mapi,
                nakon čega će biti prikazani u cjelosti. Takav način čuvanja podataka može
                biti koristan ukoliko se podaci prikupljaјu za potrebe naučnog istraživanja
                i ostavlja dovoljno vremena autoru da podatke nezavisno obјavi, prije obјaviljivanja
                u okviru Biologer platforme.
            </p>

            <p class="mb-4">
                Odabirom ove licence privremeno se ograničava vidljivost unijetih podataka
                ...
                od datuma unosa nalaza u bazu podatak će postati otvoren i dijeliće se
                pod uslovima Kriјeјtiv komons licenca, autorstvo-dijeliti pod istim uslovima (CC BY-SA 4.0).
            </p>

            <p class="mb-4">
                Izborom ove licence autori zadržavaјu sva prava nad unijetim podacima.
                Administratori Biologera i taksonomski eksperti zadržavaјu pravo
                na upotrebu podataka unijetih pod ovom licencom i to za potrebe izrade
                ...
                ali bez obјavljivanja izvornog podatka. U slučaјu korišćenja podataka za naučne publikaciјe,
                moguće јe upotrijebiti podatak u sumarnom prikazu, bez detalja o originalnom nalazu.
                U slučaјu da postoјi potreba da se izvorni podatak pod ovom licencom obјavi u cijelosti,

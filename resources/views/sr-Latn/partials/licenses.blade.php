            ...
            <div class="control">
                ...
                <b-tooltip
                    ...
                    <label class="radio">
                        ...
                        Delimično dostupni podaci (na nivou kvadrata veličine 10x10 km).<a href="{{ route('licenses.partially-open-data-license') }}" target="_blank">Detaljnije</a>
                    </label>
                </b-tooltip>
            ...
            <div class="control">
                ...
                <b-tooltip
                    ...
                    <label class="radio">
                        ...
                        ‎Skrivene fotografije (slike se uopšte ne prikazuju u javnom delu). <a href="{{ route('licenses.closed-image-license') }}" target="_blank">Detaljnije</a>
                    </label>
                </b-tooltip>
            </div>
        </div>

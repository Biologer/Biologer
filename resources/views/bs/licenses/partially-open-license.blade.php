...
@section('content')
    <div class="container">
        ...
        <section class="section has-text-justified">
            <p class="mb-4">
                Ova licenca bliže određuje pravila i uslove korištenja podataka iz
            ...
            <p class="mb-4">
                ...
                Ostali podaci koji su dostavljeni uz nalaz će biti prikazani u cijelosti.
            ...
            <p class="mb-4">
                ...
                zadržavaju pravo na upotrebu podataka unesenih pod ovom licencom i
                ...
                (npr. za potrebu zaštite i očuvanja taksona i njihovih staništa), ali bez
                objavljivanja tačne lokacije izvornog podatka. U slučaju da postoji
                potreba da se lokacija izvornog podatka koji je zabilježen pod ovom

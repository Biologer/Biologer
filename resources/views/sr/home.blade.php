    ...
    <div class="container pb-8">
        ...
        <div class="columns">
            <div class="column is-full-mobile is-one-third is-offset-one-third">
                <a href="{{ route('groups.index') }}" class="button is-primary is-outlined is-fullwidth"><b>Прегледај</b></a>
            </div>
        </div>
            ...
            <div class="column is-size-5">
                ...
                <ul class="is-done">
                    ...
                    <li>
                        ...
                        <small><b>ВАЖНО!</b> Молимо вас да инсталирате последњу верзију у којој је исправљена грешка која може изазвати губитак неких података.</small>
                    </li>
                </ul>
            </div>
            <div class="column is-size-5">

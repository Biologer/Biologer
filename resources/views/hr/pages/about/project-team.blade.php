    ...
    <section class="section content">
        <div class="container">
            ...
            <ol>
                ...
                <li>Ivona Burić – Koordinator za razvoj Biologer platforme u Hrvatskoj (Udruga Hyla, Zagreb).</li>
                <li>Toni Koren – Koordinator za razvoj Biologer platforme u Hrvatskoj (Udruga Hyla, Zagreb).</li>
            </ol>
        </div>
    </section>
@endsection

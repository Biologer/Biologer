...
return [
    ...
    'specimen_collections' => [
        'name' => 'Назив',
        'code' => 'Шифра',
        'institution_name' => 'Назив институције',
        'institution_code' => 'Шифра институције',
    ],

    'collection_observations' => [
        'collection' => 'Збирка',
        'search_for_collection' => 'Тражи збирку',
        'taxon' => 'Таксон',
        'search_for_taxon' => 'Тражи таксон',
        'date' => 'Датум',
        'year' => 'Година',
        ...
        'collecting_end_year' => 'Година краја сакупљања',
        'collecting_end_month' => 'Месец краја сакупљања',
        'collecting_method' => 'Метод сакупљања',
        'collector' => 'Сакупљач',
        'catalogue_number' => 'Каталошки број',
        'cabinet_number' => 'Ознака кабинета',
        'box_number' => 'Ознака кутије',
        'disposition' => 'Располагање',
        'type_status' => 'Типски статус',
        'preparator' => 'Препарирао/ла',
        'preparation_method' => 'Метод препарирања',
        'georeferenced_by' => 'Геореференцирао/ла',
        'georeferenced_date' => 'Датум геореференцирања',

        'add_new_collection' => 'Додајте нову збирку',

        'verbatim_data' => 'Подаци како су наведени на етикети',

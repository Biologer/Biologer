...
return [
    ...
    'preferences' => [
        ...
        'change_email' => 'Промена e-поште',
        'notifications' => 'Обавештења',
        'notifications_preferences' => 'Подешавање обавештења',
        'data_entry' => 'Унос података',
        'data_entry_preferences' => 'Подешавање уноса података',
        'token' => 'Подешавање API токена',
    ],
    ...
    'my_timed_count_observations' => 'Моја временски ограничена бројања',
    'edit' => 'Измени',
    ...
    'timed_count_observations' => 'Временска бројања',
    ...
    'reset_password' => 'Враћање лозинке',
    'verify' => 'Верификација',
    ...
    'collection_observations' => 'Подаци из збирки',
    'new_collection_observation' => 'Нови податак из збирке',
    'specimen_collections' => 'Збирке',
    'new_specimen_collection' => 'Нова збирка',
    'edit_specimen_collection' => 'Измени збирку',

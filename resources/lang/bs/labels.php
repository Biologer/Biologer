...
return [
    ...
    'field_observations' => [
        ...
        'habitat' => 'Stanište',
        'found_on' => 'Nađeno na',
        'found_on_tooltip' => 'Možete popuniti ovo polje ako je vrsta nađena na domaćinu (npr. latinski naziv biljke hraniteljke gusjenice), izmet (npr. izmet koze za skarabeje), strvina (za tvrdokrilce strvinare), supstrat, itd.',
        'sex' => 'Pol',
        'stage' => 'Stadij',
        'time' => 'Vrijeme',
        'observer' => 'Uočio',
        ...
        'choose_a_stage' => 'Odaberite stadij',
    ...
    'literature_observations' => [
        ...
        'place_where_referenced_in_publication' => 'Mjesto gde je navedeno u publikaciji',
    ...
    'specimen_collections' => [
        ...
        'institution_code' => 'Šifra institucije',
    ],

    'collection_observations' => [
        'collection' => 'Zbirka',
        'search_for_collection' => 'Traži zbirku',
        'taxon' => 'Takson',
        'search_for_taxon' => 'Traži takson',
        'date' => 'Datum',
        'year' => 'Godina',
        ...
        'original_identification' => 'Originalna identifikacija',
        'original_identification_validity' => 'Validnost originalne identifikacije',
        'verbatim_tag' => 'Tekst etikete',
        'collecting_start_year' => 'Godina početka sakupljanja',
        'collecting_start_month' => 'Mesec početka sakupljanja',
        'collecting_end_year' => 'Godina kraja sakupljanja',
        'collecting_end_month' => 'Mesec kraja sakupljanja',
        'collecting_method' => 'Metod sakupljanja',
        'collector' => 'Sakupljač',
        'catalogue_number' => 'Kataloški broj',
        'cabinet_number' => 'Oznaka kabineta',
        'box_number' => 'Oznaka kutije',
        'disposition' => 'Raspolaganje',
        'type_status' => 'Tipski status',
        'preparator' => 'Preparirao/la',
        'preparation_method' => 'Metod prepariranja',
        'georeferenced_by' => 'Georeferencirao',
        'georeferenced_date' => 'Datum georeferenciranja',

        'add_new_collection' => 'Dodajte novu kolekciju',

        'verbatim_data' => 'Podaci kako su navedeni na etiketi',
    ...
    'preferences' => [
        'account' => [
            ...
            'delete_observations' => 'Obriši i unesene nalaze',
        ],
        ...
        'notifications' => [
            ...
            'field_observation_edited' => 'Nalaz je izmijenjen',

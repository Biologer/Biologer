        ...
        <div class="table-wrapper">
            <table
                ...
                <thead>
                    <tr>
                        ...
                        <th v-for="(column, index) in columns"
                            ...
                            <div class="th-wrap" :class="{ 'is-numeric': column.numeric, 'is-centered': column.centered }">
                                ...
                                <b-icon
                                    v-if="column.sortable"
                                    :icon="currentSortColumn !== column ? 'sort' : isAsc ? 'sort-asc' : 'sort-desc'"
                    ...
                    <tr v-if="$slots.headerSecondary !== undefined">
                        <th v-if="detailed" width="40px"></th>
                        <th class="checkbox-cell" v-if="checkable"></th>

                        <slot name="headerSecondary"></slot>
                    </tr>
                </thead>
                    ...
                    <template v-for="(row, index) in visibleData">
                        <tr :key="index"
                            ...
                            <td class="checkbox-cell" v-if="checkable">
                                <input type="checkbox" :checked="isRowChecked(row)" @change="checkRow(row)">
                            </td>

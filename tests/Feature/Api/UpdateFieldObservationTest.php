...
class UpdateFieldObservationTest extends TestCase
{
    ...
    /** @test */
    public function unless_identifier_is_provided_user_will_be_assigned_as_identifier_if_identification_is_changed()
    {
        $user = factory(User::class)->create();
        ...
        tap($fieldObservation->fresh(), function ($fieldObservation) use ($user) {
    ...
    /** @test */
    public function user_will_not_be_assigned_as_identifier_if_there_was_already_one_assigned()
    {
        $user = factory(User::class)->create();
        $taxon = factory(Taxon::class)->create();
        Passport::actingAs($user);
        ...
        tap($fieldObservation->fresh(), function ($fieldObservation) use ($user) {
            $this->assertNotEquals($fieldObservation->identifier, $user->full_name);
            $this->assertNull($fieldObservation->identified_by_id);
        });
    }
}

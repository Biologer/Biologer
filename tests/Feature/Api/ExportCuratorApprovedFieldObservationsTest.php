...
final class ExportCuratorApprovedFieldObservationsTest extends TestCase
{
    #[Test]
    public function curator_can_export_approved_field_observations_they_curate(): void
    {
        Queue::fake();
    ...
    #[Test]
    public function curator_can_export_approved_observations_using_darwin_core_standard(): void
    {
        Queue::fake();
        Passport::actingAs($user = User::factory()->create());
